...
1. **Look:** presses Street View's compass to face north, then turns 90° at a time to capture north, east, south and west.
...
| Language | Telling letters (ł, ř, ğ, ã, ß) and street words (rua, calle, straße, ulica, jalan) in about 40 languages; letters that set Ukrainian, Serbian or Kazakh apart from Russian | English barely counts: it's on signs everywhere. |
...
| Domains, phone codes, brands | `.com.br`, `+48`, PEMEX, Petrobras, Żabka, Pertamina | About 40 regional chains. |
